...
=end
	...
	def generate_ca_pdf_report(ca_filepath,new_ca_filepath,ruleNumList,signData,signCert,nonce)
	    ...
	    userinfo = {channelId: 'CHN_3039394B3D71D6FD'}
            documentInfo = {docuName: '云签章', fileDesc: '云签章'}
	   reqMessage ={ruleNumList: ruleNumList, appId: '932bae8aab4c4b279ff086bd0e321764',policyType: 2, userinfo: userinfo, documentInfo: documentInfo,nonce: nonce, signCert: signCert,signData: signData}
    ...
    reqMessage ={appId: '932bae8aab4c4b279ff086bd0e321764',sealImg: sealImg, signCert: signCert,
