...
class SpkjBsbsController < ApplicationController
    ...
    def init
        ...
        temp=JgBsb.find(:all,:select=>'jg_name,jg_contacts,jg_tel,jg_email',:conditions=>["jg_province=? and jg_sp_permission=1 and jg_detection=1",session[:user_province]],:order=>"jg_province")
  ...
  def new
    ...
    @spkj_bsb.sp_s_39=session[:user_tel]
  ...
  def edit
    ...
    if @spkj_bsb.sp_s_85==''||@spkj_bsb.sp_s_85==nil
        @spkj_bsb.sp_s_85=session[:user_tname]
        @spkj_bsb.sp_s_87=session[:user_tel]
        @spkj_bsb.sp_s_88=session[:user_mail]
    end
