      ...
      params[:items].each do |item|
        begin
          ...
          unless check_item.update_attributes(
              item.permit(:JYYJJHB,:identifier, :BZFFJCX, :BZFFJCXDW, :BZZDYXX, :BZZDYXXDW, :BZZXYXX, :BZZXYXXDW, :JGDW, :JYYJ, :PDYJ, :a_category_id, :b_category_id, :c_category_id, :d_category_id, :name)
          )
            raise ActiveRecord::Rollback, checK_item.errors.first.last
          end
        rescue ActiveRecord::RecordNotFound
          check_item = CheckItem.new
          check_item.assign_attributes(item.permit(:JYYJJHB,:identifier, :BZFFJCX, :BZFFJCXDW, :BZZDYXX, :BZZDYXXDW, :BZZXYXX, :BZZXYXXDW, :JGDW, :JYYJ, :PDYJ, :a_category_id, :b_category_id, :c_category_id, :d_category_id, :name))
